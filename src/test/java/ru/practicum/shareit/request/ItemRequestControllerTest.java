...
class ItemRequestControllerTest {
    ...
    @SneakyThrows
    @Test
    void createWhenInvokedWithInvalidRequestThenReturned4xxClientError() {
        ...
        verify(itemRequestService, never()).create(1L, itemRequestInputDto);
    }
    ...
    @SneakyThrows
    @Test
    void getItemRequestsByOtherUsersInvokedWithValidUserIdAndInvalidFromAndValidSizeThenReturned5xxServerError() {
        ...
        verify(itemRequestService, never()).getItemRequestsByOtherUsers(1L, -1, 20);
    }

    @SneakyThrows
    @Test
    void getItemRequestsByOtherUsersInvokedWithValidUserIdAndValidFromAndInvalidSizeMaxThenReturned5xxServerError() {
        ...
        verify(itemRequestService, never()).getItemRequestsByOtherUsers(1L, 0, 31);
    }

    @SneakyThrows
    @Test
    void getItemRequestsByOtherUsersInvokedWithValidUserIdAndValidFromAndInvalidSizeMinThenReturned5xxServerError() {
        ...
        verify(itemRequestService, never()).getItemRequestsByOtherUsers(1L, 0, 0);
    }
