...
class ItemControllerTest {
    ...
    @SneakyThrows
    @Test
    void createWhenInvokedWithInvalidItemNameThenReturned4xxClientError() {
        itemDto.setId(null);
        itemDto.setName("");
        ...
        verify(itemService, never()).create(1L, itemDto);
    }

    @SneakyThrows
    @Test
    void createWhenInvokedWithInvalidItemDescriptionThenReturned4xxClientError() {
        itemDto.setId(null);
    ...
    @SneakyThrows
    @Test
    void createWhenInvokedWithInvalidItemAvailableThenReturned4xxClientError() {
        itemDto.setId(null);
